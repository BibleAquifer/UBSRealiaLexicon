...
These two objects were somehow used by the High Priest to find out the will of God (see, for example, NUM 27:21; 1SA 14:41; 1SA 28:6). One suggestion is that the breastpiece (see [4\.5\.5 Sacred pocket, breastpiece\<REALIA:4\.5\.5\>](#)) served as a kind of pocket into which the Urim and Thummim were placed. Questions were asked of God requiring a yes or no answer, and whichever of the objects was drawn from the pouch indicated the answer.
