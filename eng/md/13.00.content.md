...
**ALLUSION** is an indirect or general reference to information or to a text that is already well known. For example, when the Preacher in Ecclesiastes says “and the dust returns to the earth” (ECC 12:7), this appears to be an allusion to a passage in Genesis (GEN 3:19).
...
**IDIOM, or IDIOMATIC EXPRESSION,** is a combination of terms whose meanings cannot be understood by adding up the meanings of the parts. “To hang one’s head” is an English idiom. “A drop in the bucket” is an idiom coming from Hebrew (ISA 40:15). Idiomatic expressions almost always lose their meaning or convey a wrong meaning when translated literally from one language to another.

**IMMEDIATE CONTEXT** refers to the words that immediately precede or follow a discourse or segment of discourse, and which often help one to interpret the meaning of the whole section. For example, PSA 1:2 is a passage in the immediate context of PSA 1:1 and helps to interpret it. See also CONTEXT.

**IMPERATIVE** refers to forms of a verb that indicate commands or requests. In PSA 34:11 there are two imperative forms: “Come, you children, listen to me.” Imperatives are often used together with vocative expressions (“you children”). In some languages imperatives occur only in the second person; but in others imperatives also occur in the first and third persons. These are usually expressed in English by the use of “must” or “let”; for example, “They must work harder!” or “Let us go to the house of the LORD.”
...
**IRONY** occurs when a person says one thing but means another, often for the purpose of criticism, rebuke, or instruction. When Job says to his friend, “How you have helped him who has no power!” (JOB 26:2), he is using irony. He means “You have not helped at all!”
...
**READ (READING)** refers to the wording of a particular manuscript for a passage. Two manuscripts may have different wordings in the same passage, or two versions may have two different meanings. For example, in 1SA 1:24 the Hebrew text says “three bulls,” but the Greek and Syriac versions say “a three\-year\-old bull.” These are different readings. See also TEXT.
