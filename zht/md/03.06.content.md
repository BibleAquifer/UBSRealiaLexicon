...
希伯來文*gvul* 通常是指「邊界」（參[3\.7 地界、界標 (boundary marker)\<REALIA:3\.7\>](#) ），這個詞在《以西結書》中出現過幾次，意思略有不同。在EZK 40:12 中，它似乎指的是「矮牆」（“low wall”；GNT (Good News Translation (1992)) ）、「欄杆」（“railing”；CEV (Contemporary English Version) ），或僅僅是指「障礙物」（“barrier\[s]”；RSV (Revised Standard Version (1952)) 、NJPSV (New Jewish Publication Society Version) ）。在EZK 43:13; EZK 43:17; EZK 43:20 中，該詞是指祭壇底部及各層周圍的某種「邊」（“rim”；RSV (Revised Standard Version (1952)) 、NIV (New International Version (1984)) ）。
